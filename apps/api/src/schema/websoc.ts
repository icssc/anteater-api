...
export const websocSectionSchema = z.object({
  ...
  isCancelled: z.boolean().openapi({
    description:
      "Explicitly indicates whether the section has been cancelled, superseding the 'status' property. Not present in original WebSoc data and is rather generated by parsing the section_comment column.",
    example: false,
  }),
