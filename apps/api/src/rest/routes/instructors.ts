...
const instructorsByCursorRoute = createRoute({
	...
	description:
		"Retrieves instructors matching the given filters with cursor-based pagination.",
	responses: {
	...
	return c.json(
		{
			...
			data: instructorSchema
				.array()
				.parse(await service.batchGetInstructors(ucinetids)),
		},
		200,
	);
});
...
export { instructorsCursorRouter, instructorsRouter };
