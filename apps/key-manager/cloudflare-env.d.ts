/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: fe09197d2f9c6788b0a3c3c727c844fc)
// Runtime types generated with workerd@1.20260317.1 2026-02-26 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		AUTH_SECRET: string;
		USERS_DB_URL: string;
		CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_USERS_DB: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SECRET" | "USERS_DB_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_USERS_DB" | "AUTH_GOOGLE_ID" | "AUTH_GOOGLE_SECRET">> {}
}
