...
CREATE TABLE IF NOT EXISTS "websoc_section_enrollment_history" (
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "websoc_section_enrollment_history" ADD CONSTRAINT "websoc_section_enrollment_history_section_id_websoc_section_id_fk" FOREIGN KEY ("section_id") REFERENCES "public"."websoc_section"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "websoc_section_enrollment_history_section_id_index" ON "websoc_section_enrollment_history" USING btree ("section_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "websoc_section_enrollment_history_scraped_at_index" ON "websoc_section_enrollment_history" USING btree ("scraped_at");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "websoc_section_enrollment_history_section_id_scraped_at_index" ON "websoc_section_enrollment_history" USING btree ("section_id","scraped_at");