...
ALTER TABLE "dw_major_specialization_to_requirement" ADD CONSTRAINT "dw_major_specialization_to_requirement_major_id_specialization_id_catalog_year_unique" UNIQUE NULLS NOT DISTINCT("major_id","specialization_id","catalog_year");